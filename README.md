...
A twelve-week, local-first study workspace for system design interviews spanning distributed systems, backend infrastructure, ML system design, and LLM infrastructure.

The workspace includes:

- A progress-aware dashboard and complete twelve-week curriculum
- 53 technically deep modules with mechanisms, decision frameworks, diagnosed failure modes, quizzes, and primary reading
